  ...
  if (!member) {
    return (
      <div className="min-h-screen flex flex-col justify-center items-center gap-8">
        ...
        <Link to="/" className="inline-block bg-gradient-to-r from-konoha-orange to-konoha-red text-white py-3 px-8 rounded-full font-bold shadow-[0_4px_15px_rgba(196,30,58,0.4)] hover:scale-105 transition-transform">
          Kembali ke Desa
        </Link>
      </div>
    );
  ...
  return (
    <div className="pt-[100px] pb-20 min-h-screen">
      <div className="container mx-auto px-6 max-w-7xl">
        <Link to="/" className="inline-flex items-center gap-2 text-konoha-muted hover:text-konoha-orange transition-colors mb-12">
